...
/*
	...
	si cel maxim. 
	Pentru a folosi corect aritmetica pe pointeri vom imnulti indexul curent
...
/*
	a si b sunt doi pointeri la void, dar mi se specifica in enunt
	ca datele de la acele adrese sunt de tip int, asadar trebuiesc
	castati.
